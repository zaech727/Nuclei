...
const EventCard = ({ eventName, location, desc, month, day, time}) => {
        ...
        >
            <div className="flex p-4">
                ...
                <div className="flex flex-col mx-8">
                    <h1 className="text-xl font-bold text-secondarypurple">{eventName}</h1>
                    ...
                    <p className="text-sm pt-2 text-opacity-50">{desc}</p>
                </div>
            </div>
            {isExpanded && (
